    ...
    while True:
        ...
        if ret == True:
            ...
            if len(lmList) != 0:
                ...
                if side == 'Left':
                    per = np.interp(left_hip, (56, 130), (0, 100))
                    bar = np.interp(left_hip, (56, 130), (380, 50))
                    ...
                    if form == 1:
                        if per == 0:
                            if left_hip < 56 and left_knee < 70:
                                feedback = "Up"
                                if direction == 0:
                                    count += 0.5
                                    direction = 1
                ...
                if side == 'Right':
                    per = np.interp(right_hip, (56, 130), (0, 100))
                    bar = np.interp(right_hip, (56, 130), (380, 50))
                    # Bar to show squat progress
                    ...
                    if form == 1:
                        if per == 0:
                            ...
                            if right_hip < 56 and right_knee < 70:
                                feedback = "Up"
                                if direction == 0:
                                    count += 0.5
                                    direction = 1
